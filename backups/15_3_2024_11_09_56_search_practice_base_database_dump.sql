...
CREATE TABLE IF NOT EXISTS `resume_student` (
  ...
  `days_internship` varchar(255) DEFAULT NULL,
  `period_internship` varchar(255) DEFAULT NULL,
...
--
INSERT INTO `resume_student`(`resume_id`, `education`, `photo_student`, `purpose_internship`, `contact_id`, `personal_qualities`, `preferred_languages`, `professional_skills`, `days_internship`, `period_internship`) VALUES 
('1', 'Computer Science', '1d8bc6c9940ef3cef94e392a1984e842.jpg', 'Seeking internship in IT', '1', '', '', '', null, null),
('2', 'Engineering', '3b5e5580d27aabed66089cc023a9a2b2.jpg', 'Internship for gaining practical experience', '2', '', '', '', null, null),
('3', '5', 'b21dc4af58d357d8a6cb84df9919fe32.jpg', '5', '4', '5', '5', '5', null, null),
('4', '', 'd3bbbe408b47ac910574188f0cda0467.jpg', '', '7', '', '', '', null, null);
--
...
('6', 'Имя', null, 0, 'Фамилия', 'Отчество', '1234', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', '4', null, null);
--
